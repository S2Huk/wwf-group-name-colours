   ...
   <div id="profileMenu<% = intThreadNo %>" class="dropDownMenu">
    <a href="member_profile.asp?PF=<% = lngUserID & strQsSID2 %>" rel="nofollow"><div><% = strTxtMembersProfile %></div></a><%
	    		...
	    		If strAuthorHomepage <> "" AND blnHomePage Then 
	    			...
	    			If blnNoFollowTagInLinks Then Response.Write(" rel=""nofollow""")
...
%>
  ...
  <td valign="top" class="<% = strPostTableTopClass %>" style="height:15px;"><%
			...
			'Display IP if admin or moderator
			If blnAdmin OR (blnModerator AND blnModViewIpAddresses) Then Response.Write(" - " & strTxtIP & ": " & strAuthorIP & " <a href=""http://www.webwiz.co.uk/domain-tools/ip-information.htm?ip=" & Server.URLEncode(strAuthorIP) & """ target=""_blank""><img src=""" & strImagePath & "new_window.png"" alt=""" & strTxtIP & " " & strTxtInformation & """ title=""" & strTxtIP & " " & strTxtInformation & """ /></a>")
%></td>
 </tr>
...
If blnLCode Then
	...
	Response.Write("<br /><span class=""text"" style=""font-size:10px"">Copyright &copy;2001-2012 Web Wiz Ltd.</span>")
End If
'***** END WARNING - REMOVAL OR MODIFICATION OF THIS CODE WILL VIOLATE THE LICENSE AGREEMENT ******
